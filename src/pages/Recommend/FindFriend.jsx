  ...
  return (
    <div className="relative w-[169px] h-[237px]">
      <div className="relative h-[238px] -top-px bg-[100%_100%] ">
        <img
          className="absolute w-[95px] h-[95px] top-[29px] left-[35px] object-cover"
          alt={imageAlt}
          src={imageUrl}
        />
        ...
        <img
          className="absolute w-[13px] h-[13px] top-2.5 left-2.5"
          alt="Vector"
          src={ximg}
        />
        <div
          className="top-2 left-[115px] absolute w-11 h-[17px]"
  ...
  return (
    <div className="bg-white flex flex-row justify-center w-full">
      <div className="bg-white w-[553px] h-[1199px] relative">
        ...
        <img
          className="absolute w-[560px] h-[230px] top-0 left-0"
          alt="Group"
          src={groupimg}
        />
